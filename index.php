...
<html lang="en" dir="ltr">
  ...
  <div class="animated fadeInUp" style = "padding-left:10%; padding-right: 10%; padding-bottom: 10%">
    ...
    <div class="card-deck">
        ...
        <div class="card-body">
          <a href="main.php"><h3 class="card-title">Roble Dorm</h3></a>
        </div>
        <div class="card-footer">
      ...
      <div class="card-deck">
          ...
          <img class="card-img-top" src="images/pic1.jpg" alt="Card image cap">
          <div class="card-body">
            <a href="main.php"><h3 class="card-title">Canyon Gates Community</h3></a>
          </div>
          <div class="card-footer">
          ...
          <img class="card-img-top" src="images/pic2.jpeg" alt="Card image cap">
          <div class="card-body">
            <a href="main.php"><h3 class="card-title">Stanford Club Soccer</h3></a>
          </div>
          <div class="card-footer">
